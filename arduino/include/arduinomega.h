#ifndef ARDUINOPC_ARDUINOMEGA_H
#define ARDUINOPC_ARDUINOMEGA_H
...
class ArduinoMega : public Arduino
{

public:
    ArduinoMega(std::shared_ptr<SerialPort> serialPort, std::shared_ptr<GlobalLogger> globalLogger = nullptr);
    ArduinoMega(std::shared_ptr<SerialPort> serialPort, bool canCapability, std::shared_ptr<GlobalLogger> globalLogger = nullptr);
    ArduinoMega(std::shared_ptr<SerialPort> serialPort, const std::string &firmwareVersion, std::shared_ptr<GlobalLogger> globalLogger = nullptr);
    ArduinoMega(std::shared_ptr<SerialPort> serialPort, const std::string &firmwareVersion, bool canCapability, std::shared_ptr<GlobalLogger> globalLogger = nullptr);
