#ifndef ARDUINOPC_ARDUINOUNO_H
#define ARDUINOPC_ARDUINOUNO_H
...
public:
    ArduinoUno(std::shared_ptr<SerialPort> serialPort, std::shared_ptr<GlobalLogger> globalLogger = nullptr);
    ArduinoUno(std::shared_ptr<SerialPort> serialPort, bool canCapability, std::shared_ptr<GlobalLogger> globalLogger = nullptr);
    ArduinoUno(std::shared_ptr<SerialPort> serialPort, const std::string &firmwareVersion, std::shared_ptr<GlobalLogger> globalLogger = nullptr);
    ArduinoUno(std::shared_ptr<SerialPort> serialPort, const std::string &firmwareVersion, bool canCapability, std::shared_ptr<GlobalLogger> globalLogger = nullptr);
