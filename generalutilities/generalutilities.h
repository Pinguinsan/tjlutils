...
namespace GeneralUtilities 
{
    ...
    std::string toStdString(const std::string &convert);

    std::string toStdString(const char *convert);
    ...
    template<typename T>
    std::string toStdString(const T &convert) {
        std::string returnString{""};
    ...
    {
        return ((toStdString(stringType) == "\r") || (toStdString(stringType) == "\n") || (toStdString(stringType) == "\r\n") || (toStdString(stringType) == "\n\r"));
    }
}
    ...
    namespace std {
        template<typename T>
        inline string to_string(const T &convert) { return GeneralUtilities::toStdString(convert); }
